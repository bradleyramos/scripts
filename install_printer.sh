...
while [[ "$restart" == "y" ]]; then
	...
	"RICOH")
		...
		cp -r  /Users/admin/PPDS/Library/Printers/RICOH /Library/Printers/Ricoh
		;;
	"Canon")
		echo "Copying $manu dependencies, Input admin password:"
		cp -r  /Users/admin/PPDS/Library/Printers/Canon /Library/Printers/Canon
		;;
	"KONICAMINOLTA")
		echo "Copying $manu dependencies, Input admin password:"
		cp -r  /Users/admin/PPDS/Library/Printers/KONICAMINOLTA /Library/Printers/KONICAMINOLTA
		;;
	*)
